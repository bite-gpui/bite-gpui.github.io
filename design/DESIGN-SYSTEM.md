...
| Width   | What changes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ≤1180px | The nav's rail and CTA move into a drop-down sheet, leaving the mark, the trail and the two controls in the bar. It has its own breakpoint, above the others: the frontdoor row carries seven links plus the CTA since the guide pages were added, which needs a wider bar than the four anchors did, so it no longer shares 820px with the hero. On a sub-page the trail gives its section's pages to the sheet (they are rows there) and keeps a pipe to open itself. The sheet is a separate layer, so a page still in desktop layout underneath it is fine. |
...
| ≤900px  | A sub-page's bar gives up the version chip, then ≤560px the wordmark (the mark and "← Frontdoor" are the two things that never go), then ≤420px the section name. Measured through a 320px frame: the bar is 262px of the 310px it has.                                                                                                                                                                                                                                                                                                                         |
