...
| Nav pipes               | —                                                                  | 1px × 16px `--border-2`                                       | —                                                                                                                                        | The bar reads as one sentence in pipes: the mark · the way back · the section you are in · everything else · the install line — and on a sub-page the first three are the whole of it, because a reader inside one section is not helped by the guides that stand beside it (they are rows in the sheet, and in the footer, on every page). A sub-page's way back is piped on both sides (`.nav-back-group::before`/`::after`); the frontdoor splits chapters from guides (`.nav-divider`). Pseudo-elements rather than flex items — as items each would cost one of the bar's own 32px gaps                                                                                                                                                                                                                                                                                                    |
...
| ≤900px  | A sub-page's bar gives up the version chip, then the wordmark at ≤560px (the mark and "← Frontdoor" are the two that never go), and at ≤420px the frontdoor's chip and the pipes around the way back. Measured through a 320px frame: a section bar is 251px of the 274px it has.                                                                                                                                                                                                                                                                                                                                                     |
