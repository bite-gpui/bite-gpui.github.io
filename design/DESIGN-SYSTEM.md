...
| Width   | What changes                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ≤1180px | The nav collapses to a wordmark plus a hamburger, with the links and the CTA in a drop-down sheet. It has its own breakpoint, above the others: the row carries seven links plus the CTA since the guide pages were added, which needs a wider bar than the four anchors did, so it no longer shares 820px with the hero. The sheet is a separate layer, so a page still in desktop layout underneath it is fine. |
